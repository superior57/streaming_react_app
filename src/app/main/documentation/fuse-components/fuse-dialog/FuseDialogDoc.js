			...
			content={
				<div className="p-24 max-w-2xl">
					<Typography className="mb-16" component="p">
						<code>FuseDialog</code> is a simple dialog trigger for easily showing dialog messages via redux
					...
					<Typography className="mb-16" component="p">
						You can show dialog anywhere with dispatching the action openDialog, its using Material-UI's
						dialog so you can pass the props in the object:
					</Typography>
