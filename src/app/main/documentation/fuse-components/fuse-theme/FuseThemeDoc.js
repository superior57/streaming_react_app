			...
			content={
				<div className="p-24 max-w-2xl">
					<Typography className="mb-16" component="p">
						<code>FuseTheme</code> is theming component of the Fuse React. It allows to change predefined
						Material UI themes. It should wraps the <code>FuseLayout</code> component.
					</Typography>
