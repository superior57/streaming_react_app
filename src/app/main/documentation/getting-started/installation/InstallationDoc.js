			...
			content={
				<div className="p-24 max-w-2xl">
					...
					<Typography className="mb-16" component="p">
						...
						installed to your computer. We won't get into too much detail about Node.js as it's out of the
						scope of this documentation. Also you won't need to actually use Node.js, it's only required for
					...
					<Typography className="mb-16" component="p">
						You can also checkout Fuse React from github repository. Fuse React's Github repository is
						private, you can get invitation by filling the
						<a
