			...
			content={
				<div className="p-24 max-w-2xl">
					<Typography className="mb-16" component="p">
						Fuse comes with variety of different Theme Layouts which you can see and try them from the
						configuration sidebar (Click on the animated, spinning cog button from the right side of your
						screen).
					</Typography>
					...
					<Typography className="mb-16" component="p">
						Fuse React has a powerful layout system which allows you to configure and use a different layout
						per route.
					</Typography>

					<Typography className="mb-16" component="p">
						Each route can have its own layout configuration meaning that it's very easy to have pages like
						login page where there isn't any toolbar or navbar showing, without leaving the Fuse React.
					</Typography>

					<Typography className="mb-16" component="p">
						You can get more information about route configuration and its usage from
						<Link to="/documentation/working-with-fuse-react/routing">Routing documentation page</Link>.
					</Typography>
				</div>
			}
		/>
